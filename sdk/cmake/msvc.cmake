...
function(add_linker_script _target _linker_script_file)
    ...
    if(MSVC_IDE)
        # MSBuild (and the VS IDE) uses response files when invoking CL or LINK.
        ...
        # script so as to retrieve the custom linker options to be appended to
        # the linker command-line.
        set_property(DIRECTORY #"${CMAKE_CURRENT_SOURCE_DIR}"
                     APPEND PROPERTY CMAKE_CONFIGURE_DEPENDS "${_file_full_path}")
        execute_process(
        ...
        target_link_options(${_target} PRIVATE "SHELL:@\"${_gen_rsp_file}\"")
