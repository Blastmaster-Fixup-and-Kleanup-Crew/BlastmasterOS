    ...
    IN PCWSTR ArcPath)
{
    ...
    BootEntry->FriendlyName = L"\"BlastmasterOS\"";
    Options->OsLoadOptions  = L"/FASTDETECT";
    AddBootStoreEntry(BootStoreHandle, BootEntry, MAKESTRKEY(L"BlastmasterOS"));

    /* ReactOS_Debug */
    // BootEntry->BootEntryKey = MAKESTRKEY(L"ReactOS_Debug");
    BootEntry->FriendlyName = L"\"BlastmasterOS (Debug)\"";
    Options->OsLoadOptions  = L"/DEBUG /DEBUGPORT=COM1 /BAUDRATE=115200 /SOS";
    AddBootStoreEntry(BootStoreHandle, BootEntry, MAKESTRKEY(L"BlastmasterOS_Debug"));

#ifdef _WINKD_
    /* BlastmasterOS_VBoxDebug */
    // BootEntry->BootEntryKey = MAKESTRKEY(L"BlastmasterOS_VBoxDebug");
    BootEntry->FriendlyName = L"\"ReactOS (VBox Debug)\"";
    Options->OsLoadOptions  = L"/DEBUG /DEBUGPORT=VBOX /SOS";
    AddBootStoreEntry(BootStoreHandle, BootEntry, MAKESTRKEY(L"BlastmasterOS_VBoxDebug"));
#endif
#if DBG
#ifndef _WINKD_
    /* BlastmasterOS_KdSerial */
    // BootEntry->BootEntryKey = MAKESTRKEY(L"BlastmasterOS_KdSerial");
    BootEntry->FriendlyName = L"\"BlastmasterOS (RosDbg)\"";
    Options->OsLoadOptions  = L"/DEBUG /DEBUGPORT=COM1 /BAUDRATE=115200 /SOS /KDSERIAL";
    AddBootStoreEntry(BootStoreHandle, BootEntry, MAKESTRKEY(L"BlastmasterOS_KdSerial"));
#endif

    /* BlastmasterOS_Screen */
    // BootEntry->BootEntryKey = MAKESTRKEY(L"BlastmasterOS_Screen");
    BootEntry->FriendlyName = L"\"BlastmasterOS (Screen)\"";
    Options->OsLoadOptions  = L"/DEBUG /DEBUGPORT=SCREEN /SOS";
    AddBootStoreEntry(BootStoreHandle, BootEntry, MAKESTRKEY(L"BlastmasterOS_Screen"));

    /* BlastmasterOS_LogFile */
    // BootEntry->BootEntryKey = MAKESTRKEY(L"BlastmasterOS_LogFile");
    BootEntry->FriendlyName = L"\"BlastmasterOS (Log file)\"";
    Options->OsLoadOptions  = L"/DEBUG /DEBUGPORT=FILE /SOS";
    AddBootStoreEntry(BootStoreHandle, BootEntry, MAKESTRKEY(L"ReactOS_LogFile"));

    /* BlastmasterOS_Ram */
    // BootEntry->BootEntryKey = MAKESTRKEY(L"BlastmasterOS_Ram");
    BootEntry->FriendlyName = L"\"BlastmasterOS (RAM Disk)\"";
    Options->OsLoadPath     = L"ramdisk(0)\\BlastmasterOS";
    Options->OsLoadOptions  = L"/DEBUG /DEBUGPORT=COM1 /BAUDRATE=115200 /SOS /RDPATH=blastmasteros.img /RDIMAGEOFFSET=32256";
    AddBootStoreEntry(BootStoreHandle, BootEntry, MAKESTRKEY(L"BlastmasterOS_Ram"));

    /* ReactOS_EMS */
    // BootEntry->BootEntryKey = MAKESTRKEY(L"BlastmasterOS_EMS");
    BootEntry->FriendlyName = L"\"BlastmasterOS (Emergency Management Services)\"";
    Options->OsLoadPath     = ArcPath;
    Options->OsLoadOptions  = L"/DEBUG /DEBUGPORT=COM1 /BAUDRATE=115200 /SOS /redirect=com2 /redirectbaudrate=115200";
    AddBootStoreEntry(BootStoreHandle, BootEntry, MAKESTRKEY(L"BlastmasterOS_EMS"));
#endif
